...
<div class="space-y-4">
	...
	>
		...
		<p class="text-xs text-gray-400">.txt, .md, .text, .script</p>

		{#if errorMsg}
			<p class="mt-3 text-xs text-red-600">[error] {errorMsg}</p>
		{/if}
	...
	<details class="t-card {!guideOpen ? 'animate-pulse-attention' : ''}" bind:open={guideOpen}>
		...
		<div class="px-4 pb-4 space-y-4 text-xs text-gray-600">
			<!-- Front Matter -->
			<div>
				<h3 class="text-sm font-semibold text-gray-800 mb-1">Front Matter</h3>
...
-categories: AI, Education, Technology</pre>
				<div class="mt-2 space-y-1 text-gray-500 leading-relaxed">
					<p>
						<code class="text-gray-700">-type</code> — Script type as integer: 0=General, 1=Drama, 2=Lecture,
						3=News, 4=Interview
					</p>
					<p><code class="text-gray-700">-topic</code> — Main topic or title of the script</p>
					<p><code class="text-gray-700">-categories</code> — Comma-separated category tags</p>
				</div>
			</div>

			<!-- Delimiter -->
			<div>
				<h3 class="text-sm font-semibold text-gray-800 mb-1">Delimiter</h3>
				<p class="leading-relaxed">
					Use <code class="text-gray-700">---</code> on its own line to separate front matter from the
					body. This delimiter must appear exactly once.
				</p>
			</div>

			<!-- Row Metadata -->
			<div>
				<h3 class="text-sm font-semibold text-gray-800 mb-1">Row Metadata</h3>
				<p class="mb-2 leading-relaxed">
					Attach metadata to the next dialogue line using double-dash prefix. Multiple metadata
					lines can precede a single dialogue.
				</p>
...
--visual: diagram of neural network</pre>
				<div class="mt-2 space-y-1 text-gray-500 leading-relaxed">
					<p>
						<code class="text-gray-700">--key: value</code> — Stored as key-value pairs on the slide
					</p>
					<p>
						Common keys: <code>chapter</code>,
						<code>section</code>, <code>note</code>,
						<code>visual</code>
					</p>
				</div>
			</div>
			...
			<!-- Dialogue Format -->
			<div>
				<h3 class="text-sm font-semibold text-gray-800 mb-1">Dialogue Format</h3>
				<p class="mb-2 leading-relaxed">Each dialogue line produces one slide. The format is:</p>
				<pre class="t-code">name[role]: (visual description) dialogue text</pre>
				<div class="mt-2 space-y-1 text-gray-500 leading-relaxed">
					<p><code class="text-gray-700">name</code> — Speaker name (required)</p>
					<p><code class="text-gray-700">[role]</code> — Speaker role in brackets (required)</p>
					<p>
						<code class="text-gray-700">(description)</code> — Optional visual hint in parentheses
					</p>
					<p><code class="text-gray-700">dialogue</code> — The spoken text (becomes slide body)</p>
				</div>
			</div>

			<!-- Block Separation -->
			<div>
				<h3 class="text-sm font-semibold text-gray-800 mb-1">Block Separation</h3>
				<p class="leading-relaxed">
			...
			<!-- Complete Example -->
			<div>
				<h3 class="text-sm font-semibold text-gray-800 mb-1">Complete Example</h3>
				<pre class="t-code">-type: 2
